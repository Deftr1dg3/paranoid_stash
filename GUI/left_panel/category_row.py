...
#         for instance in self.category_rows:
#             if instance.is_selected and not instance._category_name == self._category_name:
#                 # print(f'SELECTED ==>\n{instance = }')
...
#         # self.body.mid_panel.refresh_panel() # type: ignore
...
#         self.on_mouse_leave(None)
    ...
    #     # print(f'{self._category_name == self._manage_data.selected_category = } {self._category_name =} {self._manage_data.selected_category = }')
